...
\john{Note there's a runtime proposal I made in hashing that could help address the idleness challenge of having to stop the whole application while the doubling is done. Doesn't help the size requirement.}
