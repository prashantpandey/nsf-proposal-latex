...
PI Pandey has showed to build a succinct data structure for storing colored de Bruijn graphs~\cite{almodaresi2017rainbowfish}. PI Martin has devised numerous string structures for computational biology.
\prashant{Martin, please add your paper on string data structures.}