...
\john{There is no theory in this section at all.}
\rob{It's \emph{not} dynamic, but we have a body of work that relies on minimal perfect hashing. It might be nice to add a MPHF (construction and query) as a research objective to this section.}
