...
Although CPUs are increasing at 2--25\%/year and single-node RAM sizes are increasing at 2-11\%/year, genomics data is increasing by 100-200\%; see Figure~\ref{fig:xxxx}.
...
\mab{Thus, even standing still is going backward.}

Thus, we need scale-up (via better algorithms and accelerators) and scale-out to solve 
