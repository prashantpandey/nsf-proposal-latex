...
require processing raw sequencing data at petabyte scales (see ~\Cref{fig:sra_data}). This project aims to
...
memory-efficient, high-performance, dynamic, and scalable GPU data structures. \mfc{is scalable enough of a synonym of distributed?  Is it better?}
We will show how to use these data structures for our target applications in comp bio, as well as some others.  \mfc{shoudl be more like: If successful, these data structures will XXX for our target applications in comp bio.}
...
\mfc{the PIs and others have shown that} Recent data structure advances~\cite{cite-something} show that
