...
Among compact lossless data structures,  compact hash tables~\cite{xxx} are used in all three applications. 
String indexes~\cite{xxxx} are used in taxonomic and pangenomics.
Among compact and lossy data structures, filters are used in \kmer analysis~\cite{xxx} and large-scale sequence search~\cite{xxx}.
\mab{This feels repetitive. Not sure how to fix.}
...
% and maybe that's the right thing to do I can't tell\mab{}
