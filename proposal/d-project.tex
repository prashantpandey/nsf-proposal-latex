...
biology applications. \mab{As we explain in this proposal (see \S{xxx} and \S{xxx})}
The key technology in these pipelines is high-performance
and scalable GPU data structures.

\mab{bad transition. need to discuss }

{\bf \Kmer analysis} refers 
\mab{wrong topic sentence. need to discuss}
...
{\bf Taxonomic classification} refers \mab{wrong topic sentence. need to discuss} to Identifying the microbial taxon or taxa
...
{\bf Pangenomics} refers \mab{wrong topic sentence. need to discuss} to storing the genome of a species as a sequence graph
