...
due to high-throughput sequencing technology (HTS), already producing
petabyte-scale datasets. Numerous applications in computational biology (\kmer
analysis, raw sequence search, taxonomic classification, and pangenomics)
require processing raw sequencing data at petabyte scale. This project aims to
build high-performance and scalable data analysis pipelines for computational
biology applications. The key technology in these pipelines is high-performance
and scalable GPU data structures.

{\bf \Kmer analysis} refers to counting length-$k$ subsequences (called \kmers)
...
{\bf Taxonomic classification} refers to Identifying the microbial taxon or taxa
...
{\bf Pangenomics} refers to storing the genome of a species as a sequence graph
