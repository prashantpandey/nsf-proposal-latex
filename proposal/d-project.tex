...
% \mab{Is there something interesting to say about parallelizing/distributing?}
...
%\mab{sketches: Jaccard index computation: }
...
\mab{Some of these data structures are compact and lossless. SUch as.... }

\mab{Some of these data structures are sketches or lossy representations of sets, such as ... }
