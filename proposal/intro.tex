...
\john{We actually need specifics on the applications that we will implement: what, specifically, will they do? input and output? is there a CPU equivalent?}

\prashant{John, I have added the below para to answer your concern.}
...
\prashant{Martin, I added the below para to answer your concern.}
\mfc{say what great things that happen if we succeed.  maybe pus something measurable?  blah orders of magintude improvement?}
