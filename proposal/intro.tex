...
%
These applications are bottlenecked by the performance of an underlying core set of data structures, including filters~\cite{cite-place-where-bottleneck}, hash tables~\cite{same}, \mfc{fill in the rest from the remainder of intro, once we've read it.}.
%
...
For concreteness, we consider the following two tools that are used throughout computational biology.
