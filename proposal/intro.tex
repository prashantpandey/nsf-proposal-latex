...
As we will see, \kmer analysis is a key part of several of the specific applications we will be addressing. \mab{can somebody (else) name these? Alice, Bob, Eve?}
