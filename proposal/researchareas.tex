...
\begin{description}
    ...
    Bender and Farach-Colton have written numerous top-tier \john{I'd rather have this not say ``top-tier'' but instead point out the work that is most relevant to data structures. Focusing on prestige may rub some reviewers the wrong way.} theory publications and have made significant contributions towards designing efficient data structures and building scalable applications using the theoretical advancements~\cite{BenderFaGo18,BenderFaJo12,BenderFaJo12a,PandeyBJ17,PandeyABFJP18Cell,PandeyBJP17a,PandeyBJP17b,conway2018optimal,JannenYuZh15a,JannenYuZh15b,YuanZhJa16,pandey2021terrace,pandey2021variantstore,pandey2022iceberght}.
    ...
    \item[High-Performance Computing (PIs Bender, Farach-Colton, Owens, and
      ...
      written a number of top-tier \john{I'd rather have this not say ``top-tier'' but instead point out the work that is most relevant to data structures. Focusing on prestige may rub some reviewers the wrong way.} papers in HPC~\cite{PandeySMB20,bender2017two,eckstein2015pebbl,agrawal1989four,bender2008communication,greenberg1999enabling},
    ...
    \prashant{Add Martin's work in Comp bio}
