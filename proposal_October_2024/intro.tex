...
\para{In this project} We aim to build high-performance and scalable
...
We will stress-test on data structural library on computational biology
...
Section~\Cref{sec:multigpu} for specifics.  
