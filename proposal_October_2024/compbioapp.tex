...
{\color{red}\large I worked on cutting this. I felt there was \emph{a lot} of overlap between what we actually wrote in this section and the longer descriptions that follow in the dedicated sections.  I viciously cut the descriptions here and instead made them forward pointers to below, while trying to maintain context.  I also am in the process of cutting down on the fleshed out descriptions below themselves.}
